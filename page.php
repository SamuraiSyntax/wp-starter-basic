...
<main id="primary" class="site-main">
  <div class="container">
    <?php
    // Breadcrumb avec gestion améliorée de l'accessibilité
    if (function_exists('yoast_breadcrumb')) {
      yoast_breadcrumb('<nav class="breadcrumb" aria-label="' . esc_attr__('Fil d\'ariane', 'wp-starter-basic') . '">', '</nav>');
    } elseif (function_exists('bcn_display')) {
      echo '<nav class="breadcrumb" aria-label="' . esc_attr__('Fil d\'ariane', 'wp-starter-basic') . '">';
      bcn_display();
      echo '</nav>';
    } else {
      echo '<nav class="breadcrumb" aria-label="' . esc_attr__('Fil d\'ariane', 'wp-starter-basic') . '">';
      ...
      echo '<a href="' . esc_url(home_url('/')) . '" class="breadcrumb__link">' . esc_html__('Accueil', 'wp-starter-basic') . '</a>';
      echo '</li>';
    ...
    ?>
        <nav class="page-navigation" aria-label="<?php esc_attr_e('Navigation entre les pages', 'wp-starter-basic'); ?>">
          <div class="page-navigation__inner">
            <?php if ($prev_post) : ?>
              <a href="<?php echo get_permalink($prev_post); ?>" class="page-navigation__link page-navigation__link--prev">
                ...
                <span class="page-navigation__text">
                  <span class="page-navigation__label"><?php esc_html_e('Page précédente', 'wp-starter-basic'); ?></span>
            ...
            <?php if ($next_post) : ?>
              <a href="<?php echo get_permalink($next_post); ?>" class="page-navigation__link page-navigation__link--next">
                <span class="page-navigation__text">
                  <span class="page-navigation__label"><?php esc_html_e('Page suivante', 'wp-starter-basic'); ?></span>
